...
Ce jeu a été fait individuellement par Nicolas Cruz. C'est un jeu d'aventure en 2D de type platformer. Ce projet a été fait sur Godot (4.4.1_stable_win64). J'ai publié Wunu World en version HTML pour le jouer en version web.
