...
Ce jeu a été fait par Nicolas Cruz. C'est jeu d'aventure en 2D de type platformer. Ce projet a été fait individuellement sur Godot (4.4.1_stable_win64). J'ai publié Wunu World en version HTML pour le jouer en version web.
